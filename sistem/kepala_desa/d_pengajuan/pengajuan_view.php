            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      ?><tr>
                            ...
                            <td><?php echo "$kolom[status]<br> <a href='status_lengkap.php?id=$kolom[id_pengajuan]'  class='btn btn-primary btn-sm'>yes</a> 
                  ...
                  <?php echo " <a href='../laporan/pengajuan_print.php?=$kolom[id_pengajuan]' class='btn btn-primary'>PRINT</a> <br>"; ?>
