                    ...
                    <div class="row">
                        <div class="col-12">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            ?><tr>
                                                        ...
                                                        <td><?php echo "$kolom[status]<br> <a href='status_selesai.php?id=$kolom[id_pengajuan]'  class='btn btn-primary btn-sm'>yes</a> 
                            ...
                            <a href='pengajuan_hapus.php?id=$kolom[id_jenis_surat]'  class='btn btn-danger btn-sm'>Hapus</a> "; ?></td>
                                    ...
                                    <?php echo " <a href='../laporan/sah_print.php?=$kolom[id_pengajuan]' class='btn btn-primary'>PRINT</a> <br>"; ?>
