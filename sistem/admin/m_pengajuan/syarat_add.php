                ...
                <div class="col-md-12">
                  ...
                  <div class="card card-danger">
                    ...
                    <div class="card-body">
                      ...
                      <form role="form" action="syarat_add_proses.php" method="post">
                        <div class="card-body col-md-8">
                          <div class="form-group">
                            <label>Jenis Surat</label>
                            <select class="custom-select" name="surat">
                              <?php
                              $queri = "SELECT * FROM jenis_surat ";
                              $hasil = mysqli_query($koneksi, $queri);
                              while ($kolom = mysqli_fetch_assoc($hasil)) {
                                echo " <option value='$kolom[id_jenis_surat]'>$kolom[nama_surat]</option>";
                              }
                              ?>
                            </select>
                          </div>
