    ...
    <main role="main">
        ...
        <article>
            <header class="section background-dark">
                <div class="line">
                    <h1 class="text-white margin-top-bottom-40 text-size-60 text-line-height-1">Kontak Person</h1>
                    <!-- <p class="margin-bottom-0 text-size-16">Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse
                        ...
                        <div class="s-12 m-12 l-6 margin-m-bottom">
                            <div class="padding-2x block-bordered border-radius">
                                ...
                                <div class="margin-left-70 margin-s-left-0 margin-bottom">
                                    <h3 class="margin-bottom-0">Alamat Kantor</h3>
                                    <p>Jalan Garuda Sakti KM. 6<br>
                                        Karya Indah/ Kec. Tapung, Kabupaten Kampar/kode pos 28291/ Riau
                                    </p>
                                </div>
                            </div>
                        </div>
