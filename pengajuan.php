                ...
                <div class="col-md-6 col-md-offset-3 col-sm-offset-3">
                    ...
                    <form class="signup-page margin-top-20" method="POST" action="pengajuan_proses.php" enctype="multipart/form-data">
                        <div class="signup-header">
                            <h2 class="margin-bottom-20">Pengajuan</h2>
                            <p><?php echo "$surat[nama_surat]"; ?></p>
                        </div>
                        <div class="row">
                            <div class="col-sm-12" hidden="">
                                <label>Jenis Surat</label>
                                <input class="form-control margin-bottom-20" type="text" name="surat" value="<?php echo "$surat[id_jenis_surat]"; ?>">
                            </div>
                        </div>
                        <label>Nik</label>
                        <input class="form-control margin-bottom-20" type="text" name="nik">
                        <label>Nama </label>
                        <input class="form-control margin-bottom-20" type="text" name="nama">
                        <label>Tempa Lahir</label>
                        <input class="form-control margin-bottom-20" type="text" name="tmpl">
                        <label>Tanggal Lahir </label>
                        <input class="form-control margin-bottom-20" type="text" name="tgll">
                        <label>Agama</label>
                        <input class="form-control margin-bottom-20" type="text" name="agama">
                        <label>Pekerjaan</label>
                        <input class="form-control margin-bottom-20" type="text" name="pk">
                        <label>No Hp</label>
                        ...
                        <?php
                        $qsyarat = mysqli_query($koneksi, "SELECT * FROM syarat WHERE id_jenis_surat='$_GET[id]' ");
